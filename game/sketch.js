...
//added later with chat so you can play it on pc

function mousePressed() {
    if (screen == startScreen) {
        if (buttonStart.right > mouseX && buttonStart.left < mouseX && buttonStart.bottom > mouseY && buttonStart.top < mouseY) {
            buttonStartPressed = true;
        }
        if (buttonSetting.right > mouseX && buttonSetting.left < mouseX && buttonSetting.bottom > mouseY && buttonSetting.top < mouseY) {
            buttonSettingPressed = true;
        }
        if (buttonLeft.right > mouseX && buttonLeft.left < mouseX && buttonLeft.bottom > mouseY && buttonLeft.top < mouseY) {
            buttonLeftPressed = true;
        }
        if (buttonRight.right > mouseX && buttonRight.left < mouseX && buttonRight.bottom > mouseY && buttonRight.top < mouseY) {
            buttonRightPressed = true;
        }
    } else if (screen == settingScreen) {
        if (buttonMusic.right > mouseX && buttonMusic.left < mouseX && buttonMusic.bottom > mouseY && buttonMusic.top < mouseY) {
            buttonMusicPressed = true;
        }
        if (buttonBack.right > mouseX && buttonBack.left < mouseX && buttonBack.bottom > mouseY && buttonBack.top < mouseY) {
            buttonBackPressed = true;
        }
    } else if (screen == pauzeScreen) {
        if (buttonMusic.right > mouseX && buttonMusic.left < mouseX && buttonMusic.bottom > mouseY && buttonMusic.top < mouseY) {
        ...
        if (buttonHome.right > mouseX && buttonHome.left < mouseX && buttonHome.bottom > mouseY && buttonHome.top < mouseY) {
            buttonHomePressed = true;
        }
    } else if (screen == tutorialScreen) {
        if (buttonTutorialStart.right > mouseX && buttonTutorialStart.left < mouseX && buttonTutorialStart.bottom > mouseY && buttonTutorialStart.top < mouseY) {
            buttonStartPressed = true;
        }
    } else if (screen == level_1WinScreen || screen == level_2WinScreen) {
        if (buttonselector.right > mouseX && buttonselector.left < mouseX && buttonselector.bottom > mouseY && buttonselector.top < mouseY) {
            buttonStartPressed = true;
        }
    } else if (screen == selectScreen) {
        if (buttonHome.right > mouseX && buttonHome.left < mouseX && buttonHome.bottom > mouseY && buttonHome.top < mouseY) {
    ...
    } else if (screen == level_1LoseScreen || screen == level_2LoseScreen || screen == level_3LoseScreen) {
        if (buttonStart.right > mouseX && buttonStart.left < mouseX && buttonStart.bottom > mouseY && buttonStart.top < mouseY) {
            buttonStartPressed = true;
        }
    } else if (screen == level_1 || screen == level_2 || screen == level_3) {
        if (buttonPauze.right > mouseX && buttonPauze.left < mouseX && buttonPauze.bottom > mouseY && buttonPauze.top < mouseY) {
            buttonPauzePressed = true;
            return;
        }

        tileA = tileGrid.getTileAtPosition(createVector(mouseX, mouseY));
...
function mouseReleased() {
    if (screen == startScreen) {
        ...
        if (buttonBack.right > mouseX && buttonBack.left < mouseX && buttonBack.bottom > mouseY && buttonBack.top < mouseX) {
            buttonBackPressed = false;
            slider.remove();
            if (level_1selected) {
                screen = level_1;
        ...
        if (buttonLevel1.right > mouseX && buttonLevel1.left < mouseX && buttonLevel1.bottom > mouseY && buttonLevel1.top < mouseY) {
            screen = level_1;
            moves = 15;
            level_1selected = true;
        }
        if (buttonLevel2.right > mouseX && buttonLevel2.left < mouseX && buttonLevel2.bottom > mouseY && buttonLevel2.top < mouseY) {
            if (level_2Unlocked) {
                screen = level_2;
                level_2selected = true;
                moves = 20;
        ...
        if (buttonLevel3.right > mouseX && buttonLevel3.left < mouseX && buttonLevel3.bottom > mouseY && buttonLevel3.top < mouseY) {
            if (level_3Unlocked) {
                screen = level_3;
                level_3selected = true;
                moves = 25;
        ...
        tileB = tileGrid.getTileAtPosition(createVector(mouseX, mouseY));
